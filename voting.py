...
#For ID Registration-------------
students_id = list(range(100000000))
...
class election():
    ...
    p2_no = 2
    p3_no = 3
    p1_name = "Ram Manohar from BTech Mechanical Engg."
    p2_name = "Shyam Lal from BTech Chemical Engg."
    p3_name = "Roshan Sodhi from BTech Physics"
    pres_1 = 0
    pres_2 = 0
    pres_3 = 0
    ...
    vp2_no = 2
    vp3_no = 3
    vp1_name = "Hardik Vaibhav from BTech Electrical"
    vp2_name = "Kevin Borja from BTech Computer Science and Engg"
    vp3_name = "Tarak Lodha from BTech Electrical Engg"
    vpres_1 = 0
    vpres_2 = 0
    vpres_3 = 0
    ...
    sec2_no = 2
    sec3_no = 3
    sec1_name = "Vinayak Deshmukh from BTech Chemical Engg."
    sec2_name = "Jay Mehta from BTech Civil Engg."
    sec3_name = "Rajni Singh from BTech Information Technology"
    sec_1 = 0
    sec_2 = 0
    sec_3 = 0
    ...
    aud2_no = 2
    aud3_no = 3
    aud1_name = "Tanya Maheswory from BTech Mechanical Engg."
    aud2_name = "Soniya Singh from BTech Electrical Engg."
    aud3_name = "Priyanka Rao from BTech Computer Science and Engg."
    aud_1 = 0
    aud_2 = 0
    aud_3 = 0
    ...
    def welcome(obj):
        ...
        print("-----------------------------------------------------------------------")
        print("                 Indian Institute of Technology (BHU)                ")
        print("                             Varanasi, U.P.                          ")
        print("                            " + datetime + "                         ")
        print("-----------------------------------------------------------------------")
        print("************* Welcome to STUDENT PARLIAMENT ELECTIONS for S.Y. 2021-2022 *************")
    ...
    def registration(obj):
        ...
        while True:
            ...
            obj.course = input("BTech/MTech in: ")
            obj.year_section = input("Year & Branch: ")
            ...
            if obj.stud_id in students_id:
                ...
                print("Course: BTech/MTech in " + obj.course)
                print("Year & Branch: " + obj.year_section)
...
#Results --------------------------------------------------------
    ...
    def result(obj):
        ...
        print("")
        print("*****************  STUDENT PARLIAMENT S.Y. 2021-2022 ******************")
        print("")
